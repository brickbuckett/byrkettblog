...
$sourcePath = "Y:\Obsidian\Second Braincell\byrkettblog\posts"
$destinationPath = "Y:\Projects\byrkettblog\content\posts"

# Set Github repo 
$myrepo = "git@github.com:brickbuckett/byrkettblog.git"
